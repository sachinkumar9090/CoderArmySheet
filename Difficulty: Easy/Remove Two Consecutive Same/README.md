<h2><a href="https://www.geeksforgeeks.org/problems/string-manipulation3706/1?sortBy=submissions&category%5B%5D=Stack&page=1&difficulty%5B%5D=0">Remove Two Consecutive Same</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><div class="starwars-lab">
...
</div></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Arrays</code>&nbsp;<code>Stack</code>&nbsp;